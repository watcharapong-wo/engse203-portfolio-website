// src/controllers/todoController.js (UPDATED)
// Business logic for Todo API endpoints with Challenge Tasks

const Todo = require('../models/Todo');

/**
 * ดึง todos ทั้งหมด (with optional filters)
